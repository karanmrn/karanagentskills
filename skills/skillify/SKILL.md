---
name: skillify
description: Create, adapt, or update Claude Code skills from chat, video, dumps, URLs, or existing skills. Handles mode selection, repo targeting, attribution, and skill best practices.
metadata:
  version: 0.2.0
---
