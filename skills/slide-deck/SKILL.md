---
name: slide-deck
description: Draft, update, convert, and export branded React slide decks in the user's slide system. Supports new decks, updates, PPTX conversion, and Playwright exports.
metadata:
  version: 0.2.0
---
