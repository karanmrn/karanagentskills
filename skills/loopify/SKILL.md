---
name: loopify
description: Set up recurring agent loops or cron tasks with the right pacing, idempotency, and stop conditions. Use for daily, weekly, hourly, or state-driven workflows.
metadata:
  version: 0.1.0
---
