...
- [high] Billing double-charges are exploding: 9 of 20 tickets report duplicate
  charges — evidence: T-025, T-033, T-039 and six others — sources agreeing: 9
...
- Verified (recounted): login-timeout, export, and dark-mode counts.
- Inferred: the churn-risk severity of the export failures.
- Single-sourced / unresolved: none.
- Citations: ticket ids resolve in the CSV.
